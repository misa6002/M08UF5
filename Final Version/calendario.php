...
if (isset($_POST['from_datetime']) && isset($_POST['to_datetime'])) {
	...
	$query = "SELECT i.nombre, i.ruta, i.fecha FROM imagenes i JOIN usuarios u ON u.id = i.usuario_id WHERE u.nombre = '$nombre' AND fecha BETWEEN '$from_datetime' AND '$to_datetime'";
